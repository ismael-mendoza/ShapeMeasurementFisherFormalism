...
def main():
    ...
    type = str, 
    help = 'Specify a directory name where the output will be \
    inputted and files read from.')
    ...
    parser.add_argument('--sigma-n', metavar = 'SIGMA_N', 
    default = cts.sigma_n,
    ...
    fisherplots = plotsfisher.fisherplots(fisher = fish, wdir = args.wdir,
