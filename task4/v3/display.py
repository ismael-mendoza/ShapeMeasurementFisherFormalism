...
def main():
    ...
    with open(filename, 'w') as csvfile:
    	...
    	galaxies = []
    	for row in reader: 
    		#generate a galaxy and can put them in a list for now only one galaxy, still do not know how to handle multiple galaxies.
    ...
    if args.bias_matrix and args.values: 
	    ...
	    for i, figure in enumerate(figuresOfBiasMatrixNumbers): 
	        SaveFigureToPdfAndOpen(figure, 'figure' + str(10) + '_' + str(i) + '.png') 
