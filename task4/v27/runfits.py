...
def main(argv):
    noise_seed, snr, wdir = (int(argv[1]), float(argv[2]), argv[3])
    ...
    mins = defaults.getMinimums(image)
    maxs = defaults.getMaximums(image)
    ...
    result_filename = os.path.join(wdir,defaults.RESULTS_DIR,
