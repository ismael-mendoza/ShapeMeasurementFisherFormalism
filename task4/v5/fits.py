...
def main():
    ...
    help = 'Specify signal to noise ratio of the run.')
    ...
    help = 'Read each of the files produces from a fits trial in rltsdir and create a .csv file in the same directory, triangle.png (the graph of results) and sumresults.csv (condensation ofr all files that is processed by triangle.png)')
    ...
    if args.run_fits:
        ...
        os.system("python readfits.py " +  str(args.wdir) + " " + str(args.galaxy_file) + " " + str(args.rltsdir))
