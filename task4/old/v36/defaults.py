...
def getInitialValuesFit(g_parameters):
    ...
    for param in g_parameters.model_param_names:
        if g_parameters.model_params[param] == 0:
            initial_values[param] = FIT_DEVIATION
        else:
            initial_values[param] = g_parameters.model_params[param]
    ...
    for param in first_galaxy_params:
        for gal_id in g_parameters.id_params:
            ...
            if param == 'flux':
                ...
                exprs[subscriptParam] = ('(1 if e_' + gal_id + '>0 else -1)' 
                                         '* sqrt' + '(e_' + gal_id + '**2-e1_' + gal_id + '**2)')
