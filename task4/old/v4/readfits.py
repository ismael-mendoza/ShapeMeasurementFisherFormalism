...
def main(argv):
    ...
    if not os.path.isdir(os.path.join(wdir, resultsdir)):
        os.mkdir(os.path.join(wdir, resultsdir))
    ...
    params = lst_params[0] #possible here create dictionary with total number of params of both galaxies, now just look at one galaxy like before. 
