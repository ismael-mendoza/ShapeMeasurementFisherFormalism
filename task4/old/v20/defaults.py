...
class names:
    ...
    def __init__(self):
        ...
        self.galaxy_parameters = []
        for model in self.gal_models_parameters.keys():
            self.galaxy_parameters += self.gal_models_parameters[model]
        self.galaxy_parameters = list(set(self.galaxy_parameters))
