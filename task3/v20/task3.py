...
def main(argv):
    ...
    orig_params['beta'] = 1.75 * np.pi                #3; ellipticity: e2
    ...
    a2_var = variance(a2_func, orig_params, param_names, CovM)

    print (math.sqrt(a2_var) / a2) * (amplitude_func(orig_params) / math.sqrt(variance(amplitude_func, orig_params, param_names, CovM))
