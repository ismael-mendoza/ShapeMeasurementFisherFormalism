...
def partialDifferentiate(func, parameter, step):
    ...
    def Dfunc(params):
        ...
        return (func(params_up) - func(params_down)) / (2 * step)

    return Dfunc

def secondPartialDifferentiate(func, parameter1, parameter2, step1, step2): 
    Df = partialDifferentiate(func, parameter1, step1)
...
def chi2(params): 
    ...
    return ((((params['gal_image'] - drawGalaxy(params['orig_params'])).array/ (params['sigma_n'])))**2).sum()
