...
def drawPlot(subplt, plot, name): 
    ...
    subplt.axes.get_xaxis().set_ticks([]) #remove numbers and ticks but can use label.
...
def secondPartialDerive(func, params, parameter1, parameter2, step1, step2, **kwargs): 

    return partialDerive(partialDerive(func, params, parameter1, step1, **kwargs), params, parameter2, step2, **kwargs)
